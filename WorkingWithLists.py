...
# setting init value to multiply elements with
total = 1
# loop through last 5 and multiply them
for item in list04[-5:]:
    total = total * item
# set q1 to updated value of the total
q1 = total
